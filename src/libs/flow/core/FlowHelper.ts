...
const removeItem = <T extends TypedEdge | TypedNode>(props: FlowRemoveItemProps<T>): FlowResult<T, null> => {
...
const findItemById = <T extends TypedEdge | TypedNode>(props: FlowFindItemByIdProps<T>): FlowResult<T, null> => {
...
const validateConnection = (
  props: FlowValidateConnectionProps
): FlowResult<FlowConnectionTypeEnum.ENTITY_ASSOCIATION | FlowConnectionTypeEnum.ENTITY_ENTITY, null> => {
...
const connectEntityToEntity = (
  ...
  const nodeNewAssociation: TypedNode = {
    ...
    position: calculateNewNodePosition({ nodes: nodes }),
...
const connectEntityToAssociation = (
...
const calculateNewNodePosition = (props: FlowCalculateNewNodePositionProps) => {
  const { nodes } = props;
