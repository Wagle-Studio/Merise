export { SettingsDefault } from "./SettingsDefault";
...
export type { Settings, SettingsBackgroundType, SettingsDispatcher, SettingsDTOInterface, SettingsDTOObject, SettingsManagerInterface, SettingsThemeType } from "./SettingsTypes";
