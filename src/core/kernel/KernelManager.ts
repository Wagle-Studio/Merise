...
import { type SaveDTOInterface, SaveDemo } from "@/core/libs/save";
...
export default class KernelManager implements KernelManagerInterface {
  ...
  handleSaveOpen = (id: string): void => {
    ...
    if (openSaveResult.data.getId() === SaveDemo.id)
      this.managers.toast.addToastSave("Démo : aucunes modifications ne sera sauvegardées");
  };
